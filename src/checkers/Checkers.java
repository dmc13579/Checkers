...
public class Checkers extends JPanel implements ActionListener, ItemListener, MouseMotionListener, MouseListener {
    ...
    ImageIcon redN=new ImageIcon(new ImageIcon("Checkers//images//red_normal.jpg").getImage());//red_normal.jpg
    ImageIcon yellowN=new ImageIcon(new ImageIcon("Checkers//images//yellow_normal.jpg").getImage());//yellow_normal.jpg
    ImageIcon redK=new ImageIcon(new ImageIcon("Checkers//images//red_king.jpg").getImage());//red_king.jpg
    ImageIcon yellowK=new ImageIcon(new ImageIcon("Checkers//images//yellow_king.jpg").getImage());//yellow_king.jpg
    ImageIcon hlp=new ImageIcon(new ImageIcon("Checkers//images//help.jpg").getImage());//help.jpg
    ImageIcon snp=new ImageIcon(new ImageIcon("Checkers//images//sound.jpg").getImage());//sound.jpg
    ImageIcon mup=new ImageIcon(new ImageIcon("Checkers//images//mute.jpg").getImage());//mute.jpg
